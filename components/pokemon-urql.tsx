...
export function useGetPokemonByNameQuery(options: Omit<Urql.UseQueryArgs<GetPokemonByNameQueryVariables>, 'query'>) {
...
export function usePokemonsQuery(options: Omit<Urql.UseQueryArgs<PokemonsQueryVariables>, 'query'>) {
  return Urql.useQuery<PokemonsQuery, PokemonsQueryVariables>({ query: PokemonsDocument, ...options });
};